...
function segmentio(analytics, settings, integrations) {
  ...
  var flushing = false;
  var apiHost = (_a2 = settings === null || settings === void 0 ? void 0 : settings.apiHost) !== null && _a2 !== void 0 ? _a2 : SEGMENT_API_HOST;
      ...
      switch (_g.label) {
        ...
        case 6:
          ...
          return [4, import(
            ...
            "./legacy-video-plugins-6AQAFT2G.js"
          ).then(function(mod) {
