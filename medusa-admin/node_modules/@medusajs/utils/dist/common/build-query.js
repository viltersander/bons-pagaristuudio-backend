    ...
    var _loop_1 = function (key, value) {
        ...
        if (typeof value === "object") {
            Object.entries(value).forEach(function (_a) {
                ...
                switch (objectKey) {
                    case "lt":
                        where[key].push((0, typeorm_1.LessThan)(objectValue));
                        break;
                    case "gt":
                        where[key].push((0, typeorm_1.MoreThan)(objectValue));
                        break;
                    case "lte":
                        where[key].push((0, typeorm_1.LessThanOrEqual)(objectValue));
                        break;
                    case "gte":
                        where[key].push((0, typeorm_1.MoreThanOrEqual)(objectValue));
                        break;
                    default:
                        if (objectValue != undefined && typeof objectValue === "object") {
                            where[key].push(buildWhere(objectValue));
                            return;
                        }
            ...
            if (where[key].length === 1) {
                ...
                where[key] = typeorm_1.And.apply(void 0, where[key]);
            }
            return "continue";
        }
        where[key] = value;
