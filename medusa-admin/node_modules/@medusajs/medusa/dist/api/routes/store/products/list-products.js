...
exports.default = (function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var productService, productVariantInventoryService, pricingService, cartService, validated, _a, cart_id, regionId, currencyCode, filterableFields, listConfig, manager, _b, computedProducts, count;
    var _c;
    return __generator(this, function (_d) {
        switch (_d.label) {
            case 0:
                ...
                if ((_c = req.publishableApiKeyScopes) === null || _c === void 0 ? void 0 : _c.sales_channel_ids.length) {
                ...
                return [4 /*yield*/, manager.transaction(function (transactionManager) { return __awaiter(void 0, void 0, void 0, function () {
                        var promises, _a, _b, rawProducts, count, cart, computedProducts, shouldSetPricing, shouldSetAvailability, decoratePromises;
                        var _c, _d;
                        return __generator(this, function (_e) {
                            switch (_e.label) {
                                ...
                                case 1:
                                    _a = __read.apply(void 0, [_e.sent(), 2]), _b = __read(_a[0], 2), rawProducts = _b[0], count = _b[1], cart = _a[1];
                                    if (validated.cart_id) {
                                    ...
                                    shouldSetAvailability = (_c = listConfig.relations) === null || _c === void 0 ? void 0 : _c.includes("variants");
                                    decoratePromises = [];
                                    if (shouldSetPricing) {
                                        decoratePromises.push(pricingService
                                            .withTransaction(transactionManager)
                                    ...
                                    if (shouldSetAvailability) {
                                        decoratePromises.push(productVariantInventoryService
                                            .withTransaction(transactionManager)
                                            .setProductAvailability(computedProducts, filterableFields.sales_channel_id));
                                    }
                                ...
                                case 2:
                                    ...
                                    // of the appropriate entity
                                    _e.sent();
                                    return [2 /*return*/, [computedProducts, count]];
                            }
                        });
                    }); })];
            case 1:
                _b = __read.apply(void 0, [_d.sent(), 2]), computedProducts = _b[0], count = _b[1];
                res.json({
