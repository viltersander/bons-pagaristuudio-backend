...
exports.default = (function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var productService, inventoryService, productVariantInventoryService, salesChannelService, pricingService, _a, skip, take, relations, manager, _b, products, count;
        ...
        switch (_c.label) {
            case 0:
                ...
                return [4 /*yield*/, manager.transaction(function (transactionManager) { return __awaiter(void 0, void 0, void 0, function () {
                        var _a, rawProducts, count, products, includesPricing, _b, salesChannelsIds;
                        return __generator(this, function (_c) {
                            switch (_c.label) {
                                ...
                                case 1:
                                    ...
                                    includesPricing = ["variants", "variants.prices"].every(function (relation) { return relations === null || relations === void 0 ? void 0 : relations.includes(relation); });
                                ...
                                case 4:
                                    ...
                                    return [4 /*yield*/, productVariantInventoryService
                                            .withTransaction(transactionManager)
                                            .setProductAvailability(products, salesChannelsIds.map(function (salesChannel) { return salesChannel.id; }))];
                                case 5:
                                    products = _c.sent();
                                    _c.label = 6;
