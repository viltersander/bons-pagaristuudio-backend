...
var seed = function (_a) {
    ...
    return __awaiter(this, void 0, void 0, function () {
        var resolvedPath, _b, configModule, error, featureFlagRouter, dbType, coreMigrations, moduleMigrations, connectionOptions, connection, app, container, manager, storeService, userService, regionService, productService, productCategoryService, productVariantService, shippingOptionService, shippingProfileService;
        var _this = this;
            ...
            switch (_c.label) {
                ...
                case 5:
                    ...
                    return [4 /*yield*/, manager.transaction(function (tx) { return __awaiter(_this, void 0, void 0, function () {
                            var _a, seededStore, regions, products, _b, categories, shipping_options, users, gcProfile, defaultProfile, store, users_1, users_1_1, u, pass, e_1_1, regionIds, regions_1, regions_1_1, r, dummyId, reg, e_2_1, shipping_options_1, shipping_options_1_1, so, e_3_1, _loop_1, products_1, products_1_1, p, e_4_1, createProductCategory, categories_1, categories_1_1, c, e_5_1;
                            var e_1, _c, e_2, _d, e_3, _e, e_4, _f, e_5, _g;
                            var _this = this;
                            return __generator(this, function (_h) {
                                switch (_h.label) {
                                    case 0:
                                        _a = JSON.parse(fs_1.default.readFileSync(resolvedPath, "utf-8")), seededStore = _a.store, regions = _a.regions, products = _a.products, _b = _a.categories, categories = _b === void 0 ? [] : _b, shipping_options = _a.shipping_options, users = _a.users;
                                        return [4 /*yield*/, shippingProfileService.retrieveGiftCardDefault()];
                                    case 1:
                                        gcProfile = _h.sent();
                                        return [4 /*yield*/, shippingProfileService.retrieveDefault()];
                                    case 2:
                                        defaultProfile = _h.sent();
                                    ...
                                    case 20:
                                        try {
                                            if (regions_1_1 && !regions_1_1.done && (_d = regions_1.return)) _d.call(regions_1);
                                        }
                                    ...
                                    case 28:
                                        _loop_1 = function (p) {
                                            var variants, newProd, optionIds_1, variants_1, variants_1_1, v, variant, e_6_1;
                                            var e_6, _j;
                                            return __generator(this, function (_k) {
                                                switch (_k.label) {
                                                    ...
                                                    case 2:
                                                        ...
                                                        variants_1 = (e_6 = void 0, __values(variants)), variants_1_1 = variants_1.next();
                                                        _k.label = 3;
                                                    case 3:
                                                    ...
                                                    case 8:
                                                        try {
                                                            if (variants_1_1 && !variants_1_1.done && (_j = variants_1.return)) _j.call(variants_1);
                                                        }
                                    ...
                                    case 35:
                                        try {
                                            if (products_1_1 && !products_1_1.done && (_f = products_1.return)) _f.call(products_1);
                                        }
                                    ...
                                    case 36:
                                        createProductCategory = function (parameters, parentCategoryId) {
                                            ...
                                            return __awaiter(_this, void 0, void 0, function () {
                                                var categoryChildren, category, categoryChildren_1, categoryChildren_1_1, categoryChild, e_7_1;
                                                var e_7, _a;
                                        ...
                                        if (!(dbType !== "sqlite")) return [3 /*break*/, 44];
                                        _h.label = 37;
                                    case 37:
                                        _h.trys.push([37, 42, 43, 44]);
                                        categories_1 = __values(categories), categories_1_1 = categories_1.next();
                                        _h.label = 38;
                                    case 38:
                                        if (!!categories_1_1.done) return [3 /*break*/, 41];
                                        c = categories_1_1.value;
                                        return [4 /*yield*/, createProductCategory(c, null)];
                                    case 39:
                                        _h.sent();
                                        _h.label = 40;
                                    case 40:
