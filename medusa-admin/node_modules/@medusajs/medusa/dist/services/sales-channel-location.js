...
var SalesChannelLocationService = /** @class */ (function (_super) {
    ...
    SalesChannelLocationService.prototype.associateLocation = function (salesChannelId, locationId) {
        return __awaiter(this, void 0, void 0, function () {
            var salesChannel, salesChannelLocation;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, this.stockLocationService_.retrieve(locationId)];
                    case 2:
                        // trhows error if not found
                        _a.sent();
                        _a.label = 3;
                    case 3:
                        salesChannelLocation = this.activeManager_.create(sales_channel_location_1.SalesChannelLocation, {
                            sales_channel_id: salesChannel.id,
                            location_id: locationId,
                        });
                        return [4 /*yield*/, this.activeManager_.save(salesChannelLocation)];
                    case 4:
                        _a.sent();
                        return [2 /*return*/];
                }
    ...
    SalesChannelLocationService.prototype.listSalesChannelIds = function (locationId) {
        return __awaiter(this, void 0, void 0, function () {
            var manager, location, salesChannelLocations;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
