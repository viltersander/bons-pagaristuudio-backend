    ...
    OrderEditService.prototype.confirm = function (orderEditId, context) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.atomicPhase_(function (manager) { return __awaiter(_this, void 0, void 0, function () {
                            var orderEditRepository, orderEdit, lineItemServiceTx, _a, lineItems;
                            var _this = this;
                            return __generator(this, function (_b) {
                                switch (_b.label) {
                                    case 0:
                                    ...
                                    case 3:
                                        ...
                                        return [4 /*yield*/, Promise.all(lineItems.map(function (lineItem) { return __awaiter(_this, void 0, void 0, function () {
                                                return __generator(this, function (_a) {
                                                    switch (_a.label) {
                                                        case 0: return [4 /*yield*/, this.inventoryService_.deleteReservationItemsByLineItem(lineItem.id)];
                                                        case 1: return [2 /*return*/, _a.sent()];
                                                    }
                                                });
                                            }); }))];
