                ...
                switch (_a.label) {
                    case 0:
                        ...
                        events = events.filter(function (event) {
                            var _a, _b, _c;
                            return (_c = (_b = (_a = _this.eventBusModuleService_) === null || _a === void 0 ? void 0 : _a.retrieveSubscribers(event.eventName)) === null || _b === void 0 ? void 0 : _b.length) !== null && _c !== void 0 ? _c : false;
                        });
                        stagedJobs = [];
                        if (!events.length) return [3 /*break*/, 2];
                    ...
                    case 1:
                        ...
                        stagedJobs = _a.sent();
                        _a.label = 2;
                    case 2: return [2 /*return*/, (!isBulkEmit ? stagedJobs[0] : stagedJobs)];
                }
            });
        });
    };
