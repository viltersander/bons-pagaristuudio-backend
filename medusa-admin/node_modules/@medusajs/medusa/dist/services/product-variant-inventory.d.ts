...
import { ICacheService, IEventBusService, IInventoryService, IStockLocationService, InventoryItemDTO, ReservationItemDTO, ReserveQuantityContext } from "@medusajs/types";
...
declare class ProductVariantInventoryService extends TransactionBaseService {
    ...
    setVariantAvailability(variants: ProductVariant[] | PricedVariant[], salesChannelId: string | string[] | undefined, variantInventoryMap?: Map<string, ProductVariantInventoryItem[]>): Promise<ProductVariant[] | PricedVariant[]>;
