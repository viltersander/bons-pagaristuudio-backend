                            ...
                            return __generator(this, function (_b) {
                                switch (_b.label) {
                                    ...
                                    case 1:
                                        ...
                                        provider = this.retrieveProvider(paymentSession.provider_id);
                                        if (!(provider instanceof interfaces_1.AbstractPaymentProcessor)) return [3 /*break*/, 2];
                                        throw new medusa_core_utils_1.MedusaError(medusa_core_utils_1.MedusaError.Types.NOT_ALLOWED, "The payment provider ".concat(paymentSession.provider_id, " is of type PaymentProcessor. PaymentProcessors cannot update payment session data."));
                                    case 2:
                                        _a = session;
