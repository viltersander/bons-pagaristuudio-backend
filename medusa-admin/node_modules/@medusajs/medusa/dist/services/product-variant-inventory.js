...
var ProductVariantInventoryService = /** @class */ (function (_super) {
    ...
    ProductVariantInventoryService.prototype.reserveQuantity = function (variantId, quantity, context) {
        if (context === void 0) { context = {}; }
        return __awaiter(this, void 0, void 0, function () {
            var toReserve, variantInventory, locationId, locationIds, _a, locations, count, reservationItems;
            var _this = this;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
    ...
    ProductVariantInventoryService.prototype.setVariantAvailability = function (variants, salesChannelId, variantInventoryMap) {
        if (variantInventoryMap === void 0) { variantInventoryMap = new Map(); }
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        if (!!variantInventoryMap.size) return [3 /*break*/, 2];
                        return [4 /*yield*/, this.listByVariant(variants.map(function (v) { return v.id; }))];
                    case 1:
                        variantInventories = _a.sent();
                        ...
                        _a.label = 2;
                    case 2: return [4 /*yield*/, Promise.all(variants.map(function (variant) { return __awaiter(_this, void 0, void 0, function () {
