 ...
 */
export declare function queryEntityWithIds<T extends ObjectLiteral>(repository: Repository<T>, entityIds: string[], groupedRelations: {
 ...
 * @param customJoinBuilders
 */
export declare function queryEntityWithoutRelations<T extends ObjectLiteral>(repository: Repository<T>, optionsWithoutRelations: Omit<ExtendedFindConfig<T>, "relations">, shouldCount?: boolean, customJoinBuilders?: ((qb: SelectQueryBuilder<T>, alias: string) => void)[]): Promise<[T[], number]>;
/**
