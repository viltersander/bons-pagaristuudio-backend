...
export declare type DefaultWithoutRelations = Omit<ExtendedFindConfig<CustomerGroup>, "relations">;
...
export declare const CustomerGroupRepository: import("typeorm").Repository<CustomerGroup> & {
    ...
    findWithRelationsAndCount(relations?: FindOptionsRelations<CustomerGroup>, idsOrOptionsWithoutRelations?: FindWithoutRelationsOptions): Promise<[CustomerGroup[], number]>;
};
