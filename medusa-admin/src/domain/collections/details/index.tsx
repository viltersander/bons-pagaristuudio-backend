...
const CollectionDetails = () => {
  ...
  const handleAddProducts = async (
    ...
    try {
      ...
      notification("Õnnestus", "Uuendatud tooted kollektsioonis", "success")
      refetch()
    } catch (error) {
    ...
    <>
      <div className="flex flex-col">
        <BackButton
          ...
          label="Tagasi kollektsioonidesse"
        />
        ...
        >
          <p className="text-grey-50 inter-base-regular mt-xsmall mb-base">
            Müügi alustamiseks vajate ainult nime, hinda ja pilti.
          </p>
          {collection && (
            <ViewProductsTable
      ...
      {showDelete && (
        <DeletePrompt
          ...
          heading="Kustuta kollektsioon"
          successText="Kollektsioon edukalt kustutatud"
