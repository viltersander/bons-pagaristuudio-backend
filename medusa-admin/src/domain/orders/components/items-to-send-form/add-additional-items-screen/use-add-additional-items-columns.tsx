    ...
    () => [
          ...
          return (
            <div className="pl-base pr-large">
              {canSelect ? (
                ...
                <Tooltip
                  content={
                    "Sellel variandil ei ole selle tellimuse piirkonna/valuuta hinda ja seda ei saa valida."
                  }
                >
                  <IndeterminateCheckbox
                    checked={getIsSelected()}
      ...
      columnHelper.accessor("title", {
        header: ({
          ...
          >
            <p className="select-none">Pealkiri</p>
            <div
      ...
      columnHelper.display({
        maxSize: 80,
        id: "options",
        header: () => <p className="select-none">Valikud</p>,
        cell: ({ row: { original } }) => {
      ...
      columnHelper.accessor("inventory_quantity", {
        maxSize: 20,
        header: () => <p className="select-none text-right">Laoseis</p>,
      ...
      columnHelper.accessor("calculated_price_incl_tax", {
        maxSize: 80,
        header: () => <p className="text-right">Hind</p>,
        cell: ({
          getValue,
          row: {
