  ...
  const handleDelete = () => {
    deleteReservation(undefined, {
      onSuccess: () => {
        notification(
          "Jaotus kustutati",
          "Eraldatud esemed on vabastatud.",
          "success"
        )
        close()
      },
      onError: () => {
        notification("Viga", "Jaotuse kustutamine ebaõnnestus", "error")
      },
    })
  }
    ...
    updateReservation(
      ...
      },
      {
        onSuccess: () => {
          notification(
            "Jaotust värskendati",
            "Jaotuse muudatus salvestati.",
            "success"
          )
          close()
        },
        onError: () => {
          notification("Viga", "Jaotuse värskendamine ebaõnnestus", "error")
        },
      }
    )
  }
        ...
        <div className="flex h-full flex-col justify-between">
          <div className="flex grow flex-col">
            <div className="border-grey-20 flex items-center justify-between border-b px-8 py-6">
              <h1 className="inter-large-semibold ">Redigeeri jaotust</h1>
            ...
            <div className="flex h-full flex-col justify-between gap-y-8 px-8 pb-8 pt-6">
              <div>
                <h2 className="inter-base-semibold">Asukoht</h2>
                <span className="inter-base-regular text-grey-50">
                Valige, millisest asukohast soovite kaubad saata.
                </span>
                <Controller
                  name="location"
                  control={control}
                ...
                <div>
                  ...
                  <span className="inter-base-regular text-grey-50">
                  Valige üksuste arv, mida soovite eraldada.
                  </span>
                  ...
                  >
                    <div className="rounded-tl-rounded">Laos</div>
                    <div className="rounded-tr-rounded">
                      {inStockQuantity ?? "N/A"}
                    </div>
                    <div className="">Saadaval</div>
                    <div className="">{availableQuantity ?? "N/A"}</div>
                    <div className="rounded-bl-rounded">Eraldada</div>
