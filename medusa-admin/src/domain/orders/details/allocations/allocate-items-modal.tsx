...
const AllocateItemsModal: React.FC<AllocateItemsModalProps> = ({
  ...
  const onSubmit = async (data: AllocationModalFormData) => {
    ...
    if (results.some((r) => r.error)) {
      ...
      notification("Üksusi ei saanud eraldada", error, "error")
    } else {
      notification(
        "Eraldatud esemed",
        "Üksused on edukalt eraldatud",
        "success"
      )
        ...
        <FocusModal.Main className="medium:w-6/12">
          {isLoading || !stock_locations ? (
            ...
            <div className="mt-16 flex flex-col">
              <h1 className="inter-xlarge-semibold">Tellimuse esemete määramine</h1>
              <div className="mt-6 flex w-full items-center justify-between">
                <div>
                  <p className="inter-base-semibold">Asukoht</p>
                  <p className="inter-base-regular">
                  Valige, kust soovite eraldada
                  </p>
                </div>
                <div className="w-1/2">
                  <Controller
              ...
              >
                <div>
                  <p className="inter-base-semibold mt-8">Eraldatavad esemed</p>
                  <p className="inter-base-regular">
  ...
  return (
    <div className="mt-8 flex w-full items-start justify-between">
      ...
      >
        ...
        >
          <p>{availableQuantity || 0} saadaval</p>
          <p>({inStockQuantity || 0} laos)</p>
        </div>
        <InputField
