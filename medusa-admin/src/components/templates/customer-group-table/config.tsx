...
export const CUSTOMER_GROUPS_CUSTOMERS_TABLE_COLUMNS: Column<Customer>[] = [
  ...
  {
    accessor: "groups",
    Header: () => <div className="text-left">Segmendid</div>,
